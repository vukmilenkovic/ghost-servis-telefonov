...
export const serviceCategories = [
  ...
  },
  {
    ...
    title: 'Zadnja stekla',
    short: 'ZS',
    description: 'Lasersko odstranjevanje in menjava zadnjega stekla z varnim lepljenjem ohisja.',
    eta: '2-4 h',
    priceHint: 'od 69 EUR',
    accent: '#6f7d2f',
  ...
  },
  {
    ...
    title: 'Zvocniki',
    short: 'ZV',
    description: 'Tiho predvajanje, hrescanje ali izpad zvoka pri klicih in medijev.',
    eta: '1-2 h',
    priceHint: 'od 39 EUR',
    accent: '#5a8f3e',
  ...
  },
  {
    ...
    title: 'Ohisja',
    short: 'OH',
    description: 'Ravnanje ali menjava ohisja, okvirja in notranjih nosilcev po poskodbah.',
    eta: '1 dan',
    priceHint: 'od 89 EUR',
    accent: '#6a8250',
    imageSrc: null,
